...
export const MIN_VERIFIED_CODEX_APP_SERVER_VERSION = "0.144.1";
export const CODEX_APP_SERVER_CONTRACT_FINGERPRINT = "codex-app-server-v2-steer-required-2026-08-05";
