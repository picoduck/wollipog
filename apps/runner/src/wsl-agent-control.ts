...
import type { WslBwrapPreparedPath } from "./wsl-bwrap-launcher.js";
...
export interface WslAgentControlLaunch {
  ...
  socketPath?: string;
  /** No-follow identity used by the native relay launcher. */
  socketDirectory?: WslBwrapPreparedPath;
}
