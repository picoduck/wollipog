...
Use relative measurements as the starting point. Numeric bounds whose safety depends on headroom go
through `expectGeometry`, while exact structural facts stay ordinary assertions:
