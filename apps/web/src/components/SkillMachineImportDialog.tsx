...
export function SkillMachineImportDialog({ runners, onClose, onImported }: {
  ...
  return <Modal title="Import Skill from Machine" wide onClose={close} footer={<>
    ...
    <div className="form skills-machine-import">
      ...
      <p className="skills-hint">Snapshot import requires protocol 111. Adoption requires a connected Linux runner on protocol 113 or newer. Symlinks, hard links, special files, executable files, and manual invocation variants are not adopted.</p>
