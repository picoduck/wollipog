...
if (SCENARIO === "conversation-handoff") {
  sessionEvents.set("session-alpha", [
    { id: 1, sessionId: "session-alpha", seq: 1, ts: 1, payload: { kind: "checkpoint", turn: 1, tree: "tree-before-turn" } },
    { id: 2, sessionId: "session-alpha", seq: 2, ts: 2, payload: { kind: "user_message", text: "Keep the interface accessible on mobile.", final: true } },
