...
export const BACKGROUND_DELIVERY_STATUS: Record<BackgroundDeliveryWatchdogState, BackgroundDeliveryStatusCopy> = {
  ...
  accepted_without_result: {
    ...
    action: "Review the parent turn and send a follow-up prompt if the result remains missing.",
    diagnostic: "The continuation was accepted, but no runner result was recorded.",
    severity: "missing",
  },
