...
test("PROTOCOL_VERSION is 185", () => {
  ...
  assert.equal(runnerSupportsProtocol(183, "skillDrift"), true);
  ...
  assert.equal(runnerSupportsProtocol(176, "harnessSelectionBackgroundConsumers"), false);
  assert.equal(runnerSupportsProtocol(177, "harnessSelectionBackgroundConsumers"), true);
  assert.equal(runnerSupportsProtocol(177, "automaticAccountSwitchHarnessSelection"), false);
  assert.equal(runnerSupportsProtocol(178, "automaticAccountSwitchHarnessSelection"), true);
  ...
  assert.equal(runnerSupportsProtocol(169, "sessionArtifactFileAttach"), true);
  ...
  assert.equal(runnerSupportsProtocol(167, "orchestratorUiEvidenceReview"), true);
  ...
  assert.equal(runnerSupportsProtocol(138, "sessionAgentControlReasoningEffort"), true);
  assert.equal(runnerSupportsProtocol(138, "typedWorkflowDecisionDelegation"), false);
  ...
  assert.equal(runnerSupportsProtocol(152, "workflowDecisionActionReconciliation"), false);
  assert.equal(runnerSupportsProtocol(153, "workflowDecisionActionReconciliation"), true);
  assert.equal(runnerSupportsProtocol(153, "verifiedAgentAvailability"), false);
  assert.equal(runnerSupportsProtocol(154, "verifiedAgentAvailability"), true);
  ...
  assert.equal(runnerSupportsProtocol(156, "orchestratorChildHarnessPolicy"), false);
  ...
  assert.equal(runnerSupportsProtocol(163, "orchestratorIntegrationIsolation"), false);
  assert.equal(runnerSupportsProtocol(164, "orchestratorIntegrationIsolation"), true);
