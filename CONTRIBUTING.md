...
Wollipog requires Node.js 22.13+ within 22.x, or 23.4+ (24 recommended; 23.0–23.3 are unsupported), pnpm, and Git. Rust and the platform C toolchain are required for desktop work.
