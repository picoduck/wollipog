...
and retained-ref reclamation. Each retained-ref row reports an opaque record, cleanup-generation,
and branch identifier; `pending`, `deleted`, `already_absent`, or `retained` state; a fixed reason;
