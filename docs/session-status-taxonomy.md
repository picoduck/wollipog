...
| Changes | Completed Git read with working-tree changes, or commits ahead of base without an open pull request | **Changes Present** | Git confirmed a real change set at the latest eligible quiescent boundary. |
