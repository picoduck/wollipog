...
Since protocol v159 the role is also independent of the provider permission mode
...
the only shape for Strict Project Isolation, Native TUI, Codex, Pi, ACP, and pre-v159 peers. The
